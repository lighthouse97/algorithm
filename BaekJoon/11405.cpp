// 11405.cpp
// 책 구매하기 1
// 'MCMF : Network Flow + 최단 거리(최소비용)' 문제이다.
// MCMF 문제에는 SPFA(Shortest Path Faster Algorithm)을 사용하는데, Edmond-Karp 알고리즘에 최단 거리 구하는
// 알고리즘이 섞여있는 것이다.
// 자세히 보면 Edmond-Karp 알고리즘과 유사하지만 중간중간 다른 부분도 보일 것이다.
// 제한시간 1초 중 28ms(2,692KB)가 소요되었다.
// 맞은사람 210/468로 상위 44.87%에 rank되었다.
